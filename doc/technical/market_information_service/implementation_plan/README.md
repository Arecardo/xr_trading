...
| QA-001 基础质量门禁 | DONE | `gofmt`、`vet`、coverage、race；当前覆盖率 88.9% |
| PLAN-001 可执行实施计划 | DONE | 领域、API、安全上下文及公共查询契约持续补齐；DOM-001～003、API-001～002、QRY-001～003 已完成，下一步进入 QRY-004 |
