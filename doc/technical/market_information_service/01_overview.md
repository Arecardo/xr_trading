...
已在 [Go 开发规范](./09_go_development_standards.md#12-测试规范) 和 [测试、CI 与发布验收计划](./implementation_plan/05_quality_and_release.md) 中固化：普通单测、Adapter fixture/fake、隔离 PostgreSQL、固定时间/UUID、并发 Gate、事务故障点和显式 Provider smoke 分层执行。
